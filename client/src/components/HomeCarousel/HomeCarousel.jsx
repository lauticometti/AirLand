		...
		<Carousel>
			...
			<Carousel.Item interval={700}>
				<a href='https://www.nike.com/es/launch/t/behind-the-design-air-force-1-roc-a-fella'>
					...
					<Carousel.Caption>
						...
						<p>
							They were more than just shoes, even from before Roc&aposs birth,
							they were an element of union between the roots of the empire.
						</p>
					</Carousel.Caption>
				</a>
			</Carousel.Item>
			...
			<Carousel.Item>
				...
				<Carousel.Caption>
					...
					<p>
						&quotWanted to create his own design of the AF-100, one of the first
						ideas he had was to incorporate his &quotacid rap&apos
						touch&apos&quot
					</p>
				</Carousel.Caption>
			</Carousel.Item>
